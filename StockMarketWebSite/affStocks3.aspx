<%@ Page Language="C#" AutoEventWireup="true" CodeFile="affStocks3.aspx.cs" Inherits="affStocks3" %>
            ...
            <tr>
                <td bordercolor="#663366" style="width: 624px; height: 38px; text-align: center">
                    ...
                    <asp:GridView ID="GVStocks" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            <asp:BoundField DataField="stockName" HeaderText="id Stock" ReadOnly="True" />
